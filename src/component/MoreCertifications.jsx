...
function MoreCertifications() {
  return (
    <div className='flex flex-col sm:flex-row justify-center items-center bg-gray-900 gap-8 mt-4 mb-4 py-6 '>
        <h3 className='text-[1.4rem] sm:text-[1.65rem] font-semibold text-center'>
